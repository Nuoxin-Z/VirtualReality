  ...
  window.addEventListener('DOMContentLoaded', function () {
    ...
    class Rocket {
      constructor(x, y, z) {
        ...
        bottomCone.setAttribute('color', 'red');
    ...
    class UFO {
      constructor(x, y, z) {
        ...
        body.setAttribute('radius', '0.5');
        body.setAttribute('color', '#00c3ffff');
        ...
        dome.setAttribute('material', 'color: #fbff00ff');
        ...
        ring.setAttribute('material', 'color: #3b0505ff; side: double');
